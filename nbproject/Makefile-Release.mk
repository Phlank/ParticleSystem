...
${OBJECTDIR}/src/graphics/Pixel.o: src/graphics/Pixel.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graphics/Pixel.o src/graphics/Pixel.cpp
...
${OBJECTDIR}/src/positioning/Particle.o: src/positioning/Particle.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/positioning/Particle.o src/positioning/Particle.cpp

${OBJECTDIR}/src/positioning/Point.o: src/positioning/Point.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/positioning
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/positioning/Point.o src/positioning/Point.cpp
